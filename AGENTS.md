...
- **Architecture is governed by:** `Atlas Constitution.md`, `Atlas Product Definition.md`, `Atlas Architecture — Runtime and Topology.md`. **`CLAUDE.md` holds the fuller engineering invariants — read it before changing runtime behavior.**
