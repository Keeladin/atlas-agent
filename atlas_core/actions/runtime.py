...
ExecutorResolver = Callable[[str, str | None, str | None], Executor]
...
class ActionRuntime:
    ...
    def _execute(self, occurrence: ActionOccurrence) -> ActionOccurrence:
        ...
        try:
            executor=self.executor_resolver(occurrence.capability_id, occurrence.principal_id, occurrence.surface)
