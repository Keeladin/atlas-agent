...
export type WorkItem = { work_id: string; display_ref?: string | null; artifact_class?: string | null; workflow_class?: string | null; objective: string; status: string; owner_principal_id: string; created_at: string; updated_at: string; metadata: Record<string, unknown>; source_cadence_id?: string | null; steps?: WorkStep[] }
